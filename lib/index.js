...
var config = (function () {
  ...
  try {
    var _ref, _join, _param, _option, _Object$assign, _Object;

    value = (_ref = (_join = join('template.js'), require(_join)), (_Object = Object, _Object$assign = _Object.assign, _param = {}, _option = option, function assign(_argPlaceholder) {
