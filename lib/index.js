...
var Rollup = function Rollup(_option) {
  ...
  this.formatRollup = function (value) {
    var _merge = merge$2({
      input: 'index.' + (_this.option.ts === true ? 'ts' : 'js'),
      output: {
...
var config = (function () {
  try {
    var _ref, _ref2, _join, _param, _option, _Object$assign, _Object;

    return _ref = (_ref2 = (_join = join('template.js'), require(_join)), (_Object = Object, _Object$assign = _Object.assign, _param = {}, _option = option, function assign(_argPlaceholder) {
      return _Object$assign.call(_Object, _param, _option, _argPlaceholder);
    })(_ref2)), formatRollup(_ref);
  } catch (_unused) {
...
var _relative, _T$dist, _join;
var base = (_relative = path.relative(root, transfer), (_join = path.join, _T$dist = T.dist, function join(_argPlaceholder) {
  return _join(_argPlaceholder, _T$dist);
})(_relative));
var cache = config.base;
var value = typeof cache == 'string' && cache ? path.join(base, cache) : base;
var baseDir = value.replace(/\\+/g, '/');
...
var copyAsync = function copyAsync(from, to) {
  var files, i, j, file, _join, _from, _pipeline, index, _ref, _cdn, _mkdirSync, src;

  return regenerator.async(function copyAsync$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          file = files[i];
          _context.next = 9;
          return regenerator.awrap(copyAsync(path.join(from, file), path.join(to, file)));
        ...
        case 14:
          ...
          if (index > -1) {
            ...
            _ref = isRoot.test(src) ? path.relative(transfer, src) : src, (_mkdirSync = mkdirSync, _cdn = absolute_cdn, function mkdirSync(_argPlaceholder) {
              return _mkdirSync(_argPlaceholder, _cdn);
            })(_ref);
          }

          _context.next = 18;
          return regenerator.awrap((_join = path.join(absolute_cdn, to), (_pipeline = pipeline, _from = from, function pipeline(_argPlaceholder2) {
...
function () {
  ...
  _createClass(Util, [{
    ...
    value: function then() {
      ...
      return regenerator.async(function then$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 3:
              ...
              value = list[i];
              clean(deps$1, value);
              cache = custom === null || custom === void 0 ? void 0 : custom[value];
            ...
            case 11:
              ...
              _context.next = 16;
              return regenerator.awrap(copyAsync(option[key], _cache));
...
var copyPackage = (function _callee(list) {
  return regenerator.async(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return regenerator.awrap(new Util(list).then());
...
function (_Get) {
  ...
  _createClass(Gett, [{
    ...
    key: "clean",
    get: function get() {
      return this.develop ? this.empty : clean$2();
    }
  }, {
    key: "sass",
    get: function get() {
...
var style = (function () {
  return gulp__default.src(_.src, _.allowEmpty).pipe(_.sourcemaps_init).pipe(_.sass).pipe(_.clean).pipe(_.sourcemaps_write).pipe(_.dest);
});
...
develop || plugins.push(rollupPluginTerser.terser());
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 7;
          return regenerator.awrap(rollup.rollup(cache));

        case 7:
          bundle = _context.sent;
          _context.next = 10;
          return regenerator.awrap(bundle.write(output));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return regenerator.awrap(copyPackage(cdn));
